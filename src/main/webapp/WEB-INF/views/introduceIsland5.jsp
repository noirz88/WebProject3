...
<div class="wrap">
    ...
    <div class="content fix">
        <figure class="vs" id="vs">
            <!-- 배경 이미지로 채움 -->
            <div class="tit_box0">
            <h2 class="vs_tit0">섬 Talk</h2>
            <p class="vs_com0">섬 이야기를 나눕니다.</p>
        </div>
        </figure>
        <div class="content_wrap">
            <div class="sub_box">
                <h2 class="sub_tit">섬 Talk</h2>
                <div class="bread_box">
                    <h3 class="cate_tit">통영 여행</h3>
                    <p class="bread"><a href="" class="home">홈</a> &gt; <a href="">한려수도향토기행</a> <!-- &gt; <span class="cur">테마별 섬</span> --></p>
            ...
            <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/sub1.jpg" 
                alt="매물도 풍경"></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">빛 과 바람의 섬! 머물수록 좋은 매물도</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 매죽리 매물도<br> · 면적 : 1.413km2 <br> · 인구 : 58세대 134명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 소매물도와 해안암벽이 장관이다.</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/비진도.jpg" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">행복하게 여유있게 머무를 수 있는 섬!</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 비진리 비진도<br> · 면적 : 2.773km2 <br> · 인구 : 104세대 184명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 산호빛 바다가 펼쳐진 비진도 섬</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/욕지도_small.jpg" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">한려수도의 보석같은 섬! 욕지도</h3>
                    <p class="card_com"><br>· 권역 : 욕지권<br> · 위치: 경상남도 통영시 욕지면 욕지도<br> · 면적 : 12.743km2 <br> · 인구 : 855세대 1,527명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 :태고의 신비를 간직한 해양웰빙휴양의 섬</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/한산도16.jpg.small.jpg" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">이충무공의 숨결이 서려 있는 한산도</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 한산도<br> · 면적 : 14.721km2 <br> · 인구 : 614세대 1,083명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 국난을 극복한 유서깊은 사적지</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/제승당.jpg" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">한산 앞바다의 영원한 지킴이</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 한산일주로 70<br> · 면적 : 2.773km2 <br> · 인구 : 104세대 184명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 임진란 충무공이 군사를 진두지휘하던 곳</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/연화도12.jpg" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">피서하기 좋은 섬!</h3>
                    <p class="card_com"><br>· 권역 : 욕지권<br> · 위치: 경상남도 통영시 욕지면 연화리<br> · 면적 : 1.720km2 <br> · 인구 : 101세대 175명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 전국 제일의 바다낚시터가 유명함</p>
                </div>
            </a>
        </li>
            </ul>
...
<!-- 1. 지도 노드 -->
<div align="center">
<div id="daumRoughmapContainer1641542509268" class="root_daum_roughmap root_daum_roughmap_landing"></div>
</div>
<!--
	2. 설치 스크립트
	...
	new daum.roughmap.Lander({
		...
		"mapHeight" : "360"
          ...
          <div class="page_box">
            ...
            <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/오곡도0.jpg.small.jpg" 
                alt="오곡도"></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">빛 과 바람의 섬! 머물수록 좋은 매물도</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 매죽리 매물도<br> · 면적 : 1.413km2 <br> · 인구 : 58세대 134명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 소매물도와 해안암벽이 장관이다.</p>
        ...
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/오비도0.jpg.small.jpg" 
                alt="오비도"></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">행복하게 여유있게 머무를 수 있는 섬!</h3>
                    <p class="card_com"><br>· 권역 : 한산권<br> · 위치: 경상남도 통영시 한산면 비진리 비진도<br> · 면적 : 2.773km2 <br> · 인구 : 104세대 184명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 : 산호빛 바다가 펼쳐진 비진도 섬</p>
        ...
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/img/추도.jpg.small.jpg" 
                alt="추도"></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">한려수도의 보석같은 섬! 욕지도</h3>
                    <p class="card_com"><br>· 권역 : 욕지권<br> · 위치: 경상남도 통영시 욕지면 욕지도<br> · 면적 : 12.743km2 <br> · 인구 : 855세대 1,527명 <br>(※ 면적.인구 : 2015년 통계연보자료)<br> · 특징 :태고의 신비를 간직한 해양웰빙휴양의 섬</p>
...
<!-- 1. 지도 노드 -->
<div align="center">
<div id="daumRoughmapContainer1641547338650" class="root_daum_roughmap root_daum_roughmap_landing"></div>
</div>
<!--
	2. 설치 스크립트
	* 지도 퍼가기 서비스를 2개 이상 넣을 경우, 설치 스크립트는 하나만 삽입합니다.
	...
	new daum.roughmap.Lander({
		...
		"mapHeight" : "360"
           ...
           <div class="page_box">
            ...
            <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_구을비도.jpg" 
                alt="매물도 풍경"></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 구을비도</h3>
                    <p class="card_com"><br>통영 남쪽, 남해 동부 끝자락에 외로이 떠있는 <br>구을비도, 아홉 마리의 새가 하늘을 나는 형상을 <br>하고 있다 해서 구을비라 불리고 있다. 굴비섬을 <br>끼고 보는 일출은 자연이 빚어내는 하나의 작품이다. 수평선 너머 홍도가 어슴푸레 보일 때쯤이면 <br>부지런한 갈매기들이 해마중을 나온다.</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_소덕도.jpg"" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 소덕도</h3>
                    <p class="card_com"><br>소덕도는 시스택, 해식곡 등 다양한 지형으로 경관이 매우 우수하고, 멸종위기야생생물 Ⅰ급인 수달이 서식하며, 다양한 상록활엽수림을 비롯하여 <br>식물구계학적 특정식물이 다수 분포하는 등 식물<br>다양성이 풍부하여 독도 등 도서지역의 생태계<br>보전에 관한 특별법에 특정도서로 지정되었다</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_송도.jpg"" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 송도</h3>
                    <p class="card_com"><br>한산도에서 임시 배편을 이용해 비산도로 향하는 뱃길은 아기자기한 섬들로 둘러싸여 조화롭기 <br>그지없다.한려수도의 아름다움을 간직한 통영은 <br>어디를 둘러봐도 맑고 청정한 푸른 바다와 신선한 해산물, 섬마을 사람들의 넉넉한 인심이 찾는 이의 마음을 푸근하게 한다.송도는 참 아름답다</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_어유도.jpg"" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 어유도</h3>
                    <p class="card_com"><br>어유도는 지형·경관이 우수하고, 상록활엽수림이 우수하고, 콩짜개덩굴, 야고 군락 등 희귀식물이 <br>생육하고 있으며, 흑비둘기·황조롱이가 서식하고 있어 독도 등 도서지역의 생태계보전에 관한 <br>특별법에 의거 특정도서로 지정되었다.</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_연도.jpg"" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 연도</h3>
                    <p class="card_com"><br>섬이 솔개같이 생겼다고 해서 '소리도'라 불리다가 솔개 '연(鳶)'자를 '연도'가 되었다. 신석기시대 <br>토기가 발견되었고, 삼국시대에는 유배지에서 <br>탈출한 사람이 땟목을 타고 넘어와 이곳에서 <br>살기 시작했다.</p>
                </div>
            </a>
        </li>
        <li>
            <a href="">
                <div class="card_wrap"><img src="${path}/include/source/무인도_잠도.jpg"" 
                alt=""></div>
                <div class="card_tit_box">
                    <h3 class="card_tit">무인도 - 잠도</h3>
                    <p class="card_com"><br>섬의 형상이 ‘커다란 새 한 마리가 바다에 앉았다 날개를 퍼덕이며 비스듬히 날아오르는 것 같다’ <br>하여 이름 붙여진 섬 ‘잠도’섬은 최고 높은 지점이 60m가 채 안 되는 야트막한 구릉으로 이루어졌으며 마을을 중심으로 나지막한 평지가 있는 것이 <br>전부인 작은 섬이다.</p>
                </div>
            </a>
        </li>
            </ul>
...
<!-- 1. 지도 노드 -->
<div align="center">
<div id="daumRoughmapContainer1641736738169" class="root_daum_roughmap root_daum_roughmap_landing"></div>
</div>
<!--
	2. 설치 스크립트
	* 지도 퍼가기 서비스를 2개 이상 넣을 경우, 설치 스크립트는 하나만 삽입합니다.
