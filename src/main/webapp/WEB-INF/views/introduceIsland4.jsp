...
<div class="wrap">
    ...
    <div class="content fix">
        <figure class="vs" id="vs">
            <!-- 배경 이미지로 채움 -->
            <div class="tit_box0">
            <h2 class="vs_tit0">여행안내</h2>
            <p class="vs_com0">오늘은 섬으로 떠나보세요.</p>
        </div>
        </figure>
        <div class="content_wrap">
            <div class="sub_box">
                <h2 class="sub_tit">여행안내</h2>
                <div class="bread_box">
                    <h3 class="cate_tit">통영 여행</h3>
                    <p class="bread"><a href="" class="home">홈</a> &gt; <a href="">여행안내</a> <!-- &gt; <span class="cur">테마별 섬</span> --></p>
